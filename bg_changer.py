...
def bg_changer(inp_img_path, bg_img_path , img_name = None):
    ...
    output = change_bg.change_bg_img(f_image_path=inp_img_path, b_image_path=bg_img_path)
    cv2.imwrite("Created_Images/Bg_Changed/" + img_name + "_bg_change.jpeg", output)
'''
