...
def bg_remover(img_path, img_name):
    '''
    ...
    output = change_bg.color_bg(image_path= img_path, colors=(0,0,0))
    cv2.imwrite("Created_Images/Bg_Removed/"+img_name+"_bg_remove.jpeg", output)
'''
bg_remover(img_path='Orignal_Images/view2.jpeg', img_name='view2.jpeg')
bg_remover(img_path='Orignal_Images/view3.jpeg', img_name='view3.jpeg')
bg_remover(img_path='Orignal_Images/view4.jpeg', img_name='view4.jpeg')
'''
